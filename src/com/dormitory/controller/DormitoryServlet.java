    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (method){
            case "list":
                ...
                req.setAttribute("buildingList", this.buildingService.list());//添加宿舍信息时要展示该列表
                req.getRequestDispatcher("dormitoryManage.jsp").forward(req, resp);
                break;
            case "search":
            ...
            case "delete":
                ...
                resp.sendRedirect("/dormitory?method=list");
                break;
            case "findByBuildingId"://学生缺寝登记展示页面，切换楼宇需要找到他对应的宿舍和学生
